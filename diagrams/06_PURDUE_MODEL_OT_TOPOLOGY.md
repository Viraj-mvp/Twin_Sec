# 06. Purdue Model Industrial OT Network Topology Diagram
...
## Node Security Classifications

```text
+-----------------------------------------------------------------------------------+
| Ring 0: Perimeter & Gateway (EWS / Jump Hosts) — Entry Vector                      |
| Ring 1: DMZ & Primary Storage (Historian) — Reconnaissance & Staging             |
| Ring 2: Operator Interface (HMI / SCADA) — Lateral Movement                      |
| Ring 3: Programmable Logic Controllers (PLC 1-3) — Command & Control (C2)         |
| Ring 4: Safety Instrumented Systems (SIS / ESD) — Action on Objectives (AOO)      |
| Ring 5: Physical Process (Breakers / Valves / Generators) — Consequence           |
+-----------------------------------------------------------------------------------+
```
